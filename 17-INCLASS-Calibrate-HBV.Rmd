...
![for loop](images/for loop.png "for loop")
...
FC    <-   #Max soil moisture storage, field capacity
beta  <-    #Shape coefficient governing fate of water input to soil moisture storage
...
#MAXBAS is just 1's because routing will be set to zero, so the parameter isn't used
 ...
 #create NSE column, to be filled in for loop
...
![monte carlo for loop](images/monte carlo for loop.png "Monte Carlo for loop")
